...
}, '1.5.2' ,{requires:['aui-template'], skinnable:false});
...
}, '1.5.2' ,{requires:['aui-tpl-snippets-base'], skinnable:false});
...
AUI.add('aui-tpl-snippets', function(A){}, '1.5.2' ,{skinnable:false, use:['aui-tpl-snippets-base','aui-tpl-snippets-select','aui-tpl-snippets-input','aui-tpl-snippets-textarea','aui-tpl-snippets-checkbox']});
