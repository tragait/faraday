...
}, '1.5.2' ,{skinnable:true, requires:['aui-scheduler-view','datasource']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-scheduler-event','aui-calendar','aui-button-item','dd-drag','dd-delegate','dd-drop','dd-constrain']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','aui-color-util','aui-datatype','aui-template','aui-toolbar','io-form','querystring','overlay']});
...
}, '1.5.2' ,{requires:['aui-scheduler-event'], skinnable:false});


AUI.add('aui-scheduler', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-scheduler-base','aui-scheduler-view','aui-scheduler-event','aui-scheduler-calendar']});
