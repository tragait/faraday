...
}, '1.5.2' ,{requires:['aui-component','widget-position','widget-stack','widget-position-align','widget-position-constrain','widget-stdmod']});
...
}, '1.5.2' ,{requires:['aui-overlay-manager','aui-delayed-task','aui-aria']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-overlay-context','anim']});
...
}, '1.5.2' ,{requires:['aui-base','aui-overlay-base','overlay','plugin']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','aui-overlay-base','event-resize']});


AUI.add('aui-overlay', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-overlay-base','aui-overlay-context','aui-overlay-context-panel','aui-overlay-manager','aui-overlay-mask']});
