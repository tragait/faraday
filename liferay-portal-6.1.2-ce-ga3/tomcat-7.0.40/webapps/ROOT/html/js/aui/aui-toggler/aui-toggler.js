...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','transition']});
...
}, '1.5.2' ,{requires:['aui-toggler-base'], skinnable:false});


AUI.add('aui-toggler', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-toggler-base','aui-toggler-delegate']});
