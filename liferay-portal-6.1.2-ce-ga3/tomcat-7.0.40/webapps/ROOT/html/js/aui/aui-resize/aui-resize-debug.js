...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','dd-drag','dd-delegate','dd-drop']});
...
}, '1.5.2' ,{requires:['aui-resize-base','dd-constrain','plugin'], skinnable:false});


AUI.add('aui-resize', function(A){}, '1.5.2' ,{use:['aui-resize-base','aui-resize-constrain'], skinnable:true});
