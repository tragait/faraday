...
}, '1.5.2' ,{skinnable:true, requires:['anim','aui-overlay-mask']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-image-viewer-base','aui-paginator','aui-toolbar']});
...
}, '1.5.2' ,{requires:['aui-image-viewer-base'], skinnable:false});


AUI.add('aui-image-viewer', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-image-viewer-base','aui-image-viewer-gallery','aui-media-viewer-plugin']});
