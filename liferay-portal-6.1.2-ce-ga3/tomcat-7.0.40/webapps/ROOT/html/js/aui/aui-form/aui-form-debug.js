...
}, '1.5.2' ,{requires:['aui-base','aui-data-set','aui-form-field','querystring-parse','io-form']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-form-textarea','aui-toolbar']});
...
}, '1.5.2' ,{requires:['aui-base','aui-component']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-form-textfield']});
...
AUI.add('aui-form', function(A){}, '1.5.2' ,{use:['aui-form-base','aui-form-combobox','aui-form-field','aui-form-select','aui-form-textarea','aui-form-textfield'], skinnable:false});
