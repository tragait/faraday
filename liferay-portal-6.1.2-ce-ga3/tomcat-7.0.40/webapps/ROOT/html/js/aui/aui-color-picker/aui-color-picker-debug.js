...
}, '1.5.2' ,{skinnable:true, requires:['aui-overlay-context','dd-drag','slider','aui-button-item','aui-color-util','aui-form-base','aui-panel']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-color-picker-base','plugin']});


AUI.add('aui-color-picker', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-color-picker-base','aui-color-picker-grid-plugin']});
