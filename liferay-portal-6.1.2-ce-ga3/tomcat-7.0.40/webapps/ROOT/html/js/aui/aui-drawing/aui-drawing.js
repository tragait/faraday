...
}, '1.5.2' ,{requires:['aui-base','aui-color-util','substitute']});
...
}, '1.5.2' ,{requires:['aui-drawing-base'], condition: {name: 'aui-drawing-svg', trigger: 'aui-drawing-base',test: function(A){return A.UA.svg;}}});
...
}, '1.5.2' ,{requires:['aui-drawing-base'], condition: {name: 'aui-drawing-vml', trigger: 'aui-drawing-base',test: function(A){return A.UA.vml;}}});
...
}, '1.5.2' ,{requires:['aui-drawing-base']});
...
}, '1.5.2' ,{requires:['aui-drawing-base','event-gestures']});
...
}, '1.5.2' ,{requires:['aui-drawing-base'], condition: {name: 'aui-drawing-safari', trigger: 'aui-drawing-base',test: function(A){var UA = A.UA; return UA.safari && (UA.version.major < 4 || (UA.iphone || UA.ipad));}}});


AUI.add('aui-drawing', function(A){}, '1.5.2' ,{skinnable:false, use:['aui-drawing-base', 'aui-drawing-animate', 'aui-drawing-drag', 'aui-drawing-fonts']});
