...
}, '1.5.2' ,{requires:['aui-node-base','aui-event-base','event-synthetic'], condition: {name: 'aui-event-delegate-change', trigger: 'event-base-ie', ua: 'ie'}});
...
}, '1.5.2' ,{requires:['aui-node-base','aui-event-base','event-synthetic'], condition: {name: 'aui-event-delegate-submit', trigger: 'event-base-ie', ua: 'ie'}});


AUI.add('aui-event', function(A){}, '1.5.2' ,{skinnable:false, use:['aui-event-base','aui-event-input']});
