...
}, '1.5.2' ,{requires:['aui-base','datasource','dataschema']});
...
}, '1.5.2' ,{requires:['aui-base','aui-datasource-control-base','aui-form-combobox']});


AUI.add('aui-datasource-control', function(A){}, '1.5.2' ,{use:['aui-datasource-control-base','aui-input-text-control'], skinnable:true});
