...
}, '1.5.2' ,{requires:['aui-base','aui-task-manager'], skinnable:false});
...
}, '1.5.2' ,{requires:['aui-tree-data','aui-tree-io','aui-tree-paginator','json','querystring-stringify'], skinnable:false});
...
}, '1.5.2' ,{requires:['aui-base'], skinnable:false});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-tree-node','aui-tree-paginator','aui-tree-io','dd-delegate','dd-proxy']});
...
}, '1.5.2' ,{requires:['aui-io','json'], skinnable:false});


AUI.add('aui-tree', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-io', 'aui-tree-paginator', 'aui-tree-view']});
