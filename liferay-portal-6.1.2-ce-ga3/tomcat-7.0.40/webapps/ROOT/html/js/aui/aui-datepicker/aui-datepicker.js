...
}, '1.5.2' ,{skinnable:true, requires:['aui-calendar','aui-overlay-context']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-datepicker-base','aui-button-item']});


AUI.add('aui-datepicker', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-datepicker-base','aui-datepicker-select']});
