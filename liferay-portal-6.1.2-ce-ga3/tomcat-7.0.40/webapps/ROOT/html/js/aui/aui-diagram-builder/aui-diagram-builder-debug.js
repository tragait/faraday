...
}, '1.5.2' ,{skinnable:true, requires:['aui-tabs','aui-property-list','collection','dd']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-data-set','aui-diagram-builder-base','aui-diagram-builder-connector','overlay']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','aui-template','arraylist-add','arraylist-filter','json','graphics','dd']});


AUI.add('aui-diagram-builder', function(A){}, '1.5.2' ,{use:['aui-diagram-builder-base','aui-diagram-builder-impl'], skinnable:true});
