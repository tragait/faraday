...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','datatable','plugin']});
...
}, '1.5.2' ,{requires:['aui-datatable-base']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-calendar','aui-datatable-events','aui-toolbar','aui-form-validator','overlay','sortable']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-datatable-base']});


AUI.add('aui-datatable', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-datatable-base','aui-datatable-events','aui-datatable-edit','aui-datatable-selection']});
