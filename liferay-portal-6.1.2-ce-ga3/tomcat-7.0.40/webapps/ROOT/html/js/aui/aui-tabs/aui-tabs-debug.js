...
}, '1.5.2' ,{skinnable:true, requires:['aui-component','aui-state-interaction']});
...
}, '1.5.2' ,{requires:['aui-component','aui-state-interaction','aui-tabs-base','aui-overlay-context','plugin']});


AUI.add('aui-tabs', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-tabs-base','aui-tabs-menu-plugin']});
