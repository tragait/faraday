...
}, '1.5.2' ,{skinnable:true, requires:['aui-base','aui-button-item','aui-data-set','aui-diagram-builder-base','aui-nested-list','aui-tabs']});
...
}, '1.5.2' ,{skinnable:true, requires:['aui-datatype','aui-panel','aui-tooltip']});


AUI.add('aui-form-builder', function(A){}, '1.5.2' ,{skinnable:true, use:['aui-form-builder-base','aui-form-builder-field']});
